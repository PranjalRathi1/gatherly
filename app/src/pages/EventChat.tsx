...
const EventChat = () => {
  ...
  if (error || !event) {
    return (
      <div className="chat-page flex items-center justify-center p-4">
        <Alert className="bg-[#111] border-[#2a2a2a] text-white max-w-md">
          <AlertDescription>
  ...
  return (
    <div className="chat-page flex flex-col min-h-screen">
      {/* Header */}
      <header className="bg-[#111] border-b border-[#2a2a2a] px-6 py-4 flex justify-between items-center sticky top-0 z-10">
                ...
                <div className="max-w-[70%]">
                  <div
                    className={`px-4 py-3 ${isMyMessage
                      ...
                      : 'bg-[#1a1a1a] text-white border border-[#2a2a2a] rounded-2xl rounded-bl-md'
                      }`}
                  >
                  ...
                  <div
                    className={`text-xs text-gray-400 mt-1 ${isMyMessage ? 'text-right' : 'text-left'
                      }`}
                  >
      ...
      {/* Input */}
      <div className="sticky bottom-0 bg-[#111] border-t border-[#2a2a2a] p-4">
        <form onSubmit={handleSendMessage} className="flex gap-2">
          <Input
            value={newMessage}
            onChange={handleTyping}
            placeholder="Type your message..."
            className="flex-1 px-4 py-3 rounded-full bg-[#1a1a1a] border border-[#2a2a2a] text-white"
